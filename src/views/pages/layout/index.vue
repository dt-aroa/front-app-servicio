...
<template>
  <div class="bg-gray-100">
    <Menubar
      :model="items"
      class="custom-menubar !bg-gray-900 shadow-lg"
      :pt="{
    ...
    >
      ...
      <template #end>
        <Button
          ...
          class="p-button-rounded p-button-text p-button-xl custom-logout-button !text-white"
          @click="handleLogout"
        />
      </template>
    </Menubar>
...
.custom-menubar .p-menubar-item-label {
  color: inherit !important; /* que hereden el blanco del content */
}
